 ...
 */
export declare function runWithRLSContext<T>(context: RLSContext, fn: () => T): T;
/** The RLS context in scope for the current async execution, if any. */
export declare function getCurrentRLSContext(): RLSContext | undefined;
/**
 ...
 */
export declare function attachRLSPoolWrapper(pool: Pool): void;
