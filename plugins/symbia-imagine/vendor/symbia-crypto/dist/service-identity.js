...
import { generateIdentity, identityFromPrivatePem, exportPrivatePem, identityId, } from './identity.js';
/**
 ...
 * would be a stranger.
 */
export function loadServiceIdentity(opts) {
    const dir = opts.dir
 ...
 */
export function describeServiceIdentity(s) {
