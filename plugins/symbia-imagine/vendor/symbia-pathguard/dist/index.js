...
export function isPathBlocked(relativePath, blockedPaths) {
 ...
 */
export function resolveSafePath(rootPath, targetPath) {
...
export function validatePath(rootPath, targetPath, operation, permissions) {
 ...
 */
export async function resolveConfinedPath(rootPath, targetPath, policy) {
