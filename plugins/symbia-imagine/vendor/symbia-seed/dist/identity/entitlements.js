...
import { DEFAULT_USER_IDS, ENTITLEMENT_KEYS, ROLE_KEYS, } from "../shared/constants.js";
import { SeedLogger, shouldSeed, getSeedTimestamp } from "../shared/utils.js";
/**
 * Generate default user entitlements
 */
export function generateDefaultUserEntitlements() {
 ...
 */
export function generateDefaultUserRoles() {
    return [
 ...
 */
export async function seedUserEntitlements(db, userEntitlementsTable, config = {}) {
 ...
 */
export async function seedUserRoles(db, userRolesTable, config = {}) {
    const logger = new SeedLogger(config.verbose);
    try {
