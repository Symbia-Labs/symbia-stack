 ...
 * Super admins implicitly have all capabilities.
 */
export function hasAnyCapability(context, capabilities) {
    if (context.isSuperAdmin) {
        return true;
    }
 ...
 * Super admins implicitly have all capabilities.
 */
export function hasAllCapabilities(context, capabilities) {
    if (context.isSuperAdmin) {
        return true;
    }
 ...
 */
export function canBypassOrgFilter(context) {
 ...
 */
export function canBypassOrgFilterForService(context, service) {
    if (context.isSuperAdmin) {
        return true;
    }
 ...
 */
export function isOrgAdmin(context, orgId) {
    if (context.isSuperAdmin) {
        return true;
    }
 ...
 */
export function isOrgMember(context, orgId) {
    if (context.isSuperAdmin) {
        return true;
    }
 ...
 */
export function getAccessibleOrgIds(context) {
 ...
 */
export function systemContext(serviceId, orgId) {
    return {
        authType: 'system',
