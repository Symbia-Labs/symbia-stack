/**
 * Route registration for the Assistants service.
 *
 * Extracted from index.ts 15 Aug 2026. It was an arrow function inside the
 * createSymbiaServer config literal — the least reachable shape of the four
 * this refactor found, since it had no name to import even in principle.
 * A route table is a value. See docs/proposals/service-composition.md.
 */
